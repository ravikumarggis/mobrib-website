        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
              Mobrib makes sending packages easier and cheaper than ever before.
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                <div
                  className={`w-16 h-16 rounded-xl bg-gradient-to-br ${stat.color} flex items-center justify-center mb-4`}
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                title: "Secure Packaging",
                description:
                  "Your parcels are handled with utmost care and protection",
                color: "bg-pink-500",
              },
              {
                icon: Users,
                title: "Trusted Network",
                description:
                  "Connect with verified travelers and senders in our community",
                color: "bg-teal-500",
              },
            ].map((feature, index) => (
              <div
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-cyan-50">
        <div className="">
          ...
          <Swiper
           ...
           className="smooth-swiper equal-height-swiper"
          >
            {features?.map((feature, index) => (
              <SwiperSlide key={index}>
                <div className="min-h-[250px] bg-white p-8 rounded-2xl  hover:shadow-xl transition-all hover:-translate-y-1 h-full">
                  <div
                    className={`w-14 h-14 ${feature.color} rounded-xl flex items-center justify-center mb-4`}
                  >
                    <feature.icon className="w-7 h-7 text-white" />
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg">
              Send your parcels in three simple steps
            </p>
          </div>
